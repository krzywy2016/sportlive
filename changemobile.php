		...
		if ($result = $mysqli->query($sql)) {
			...
			while ($row = $result->fetch_assoc()) {
				...
				if($row['team'] == $teamhome)
				{
					...
					<span style='font-size: 15px; color: #808080; font-family: Calibri;'>".$row['time']."</span>
					</div>
					<div class='col-2'>
					<img src='/images/change.png' />
					</div>
					<div class='col-8'>
						<b><span style='color: red; font-size: 12px;'>".$row['playeroff']."</span></b><br /><b><span style='color: green; font-size: 12px;'>".$row['playeron']."</span></b>
					</div>
					<div class='col-12'>
						<hr>
					</div></div>
